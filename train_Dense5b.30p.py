...
print('creating net')    
densenet = DenseNet((128,128,1), nb_classes=15, depth=25)
...
filepath = "Incremental/30p/5c/Dense15.comp.Aug-{epoch:02d}-{loss:.2f}.hdf5"
...
model.save('models/SingleModel.5.30p.hdf5')        
