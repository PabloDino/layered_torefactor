...
def importData():
    # Read Data
    data = pd.read_csv('/home/paul/Downloads/UrbanSound8K/metadata/UrbanSound8K.csv')
...
def trainData(dataset):
    ...
    model.add(MaxPooling2D((4, 2), strides=(4, 2)))
    model.add(Activation('relu'))
    model.add(LSTM(return_sequences=True, name='lstm1',unit_forget_bias=1.0,dropout=0.2))
