...
ls_5b= layers.LSTM(latent_dim ,return_sequences=True,unit_forget_bias=1.0)(re_4b)
re_5b = layers.Reshape(target_shape=(latent_dim,digitSize,1),input_shape=(latent_dim,digitSize))(ls_5b)
...
filepath = "check.32lstm-model-{epoch:02d}-{loss:.2f}.hdf5"
...
vae.save_weights('vae32blstm._mlp_mnist_latent_dim_%s.h5' %latent_dim)
encoder.save('encoder.fine.32blstm.h5')
...
def plot_label_clusters(vae, data, labels):
    ...
    plt.ylabel("z[1]")
    #plt.show()
    plt.savefig("clusters.32blstm.png")
