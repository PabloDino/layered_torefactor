...
def cloneBranchedModel(modelbase, encModel, startLayer,totalLabel):
    print("BASE")
    encModel.summary()
    input_shape_a=encModel.layers[startLayer-1].get_output_at(0).shape#(128, 128,1)
...
if __name__ == '__main__':
    ...
    for i in range(15, len(modelbase.layers[:-2])):
      ...
      modelNew,origBranch,otherBranch= cloneBranchedModel(modelbase,encModel, startLyr, totalLabel)
      #modelNew.summary()
