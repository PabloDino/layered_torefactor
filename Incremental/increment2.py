...
from keras.layers import Activation, Dense, Dropout, Conv2D, GlobalAveragePooling2D, \
...
if __name__ == '__main__':
    ...
    concatC = Concatenate(axis=3, name = 'outconcat')([denseIn1,b1_conv1b,b2_conv1b, b3_conv])
