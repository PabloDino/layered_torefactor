...
def fitCombined(xTrain,xTest, y_train, y_test,combModel):#,fixedLayers):
    ...
    indata = [xTrain,xTrain,xTrain,xTrain]
    #''' 
    #indata=xTrain
    ...
    combModel.fit(indata,
        ...
        validation_data= ([xTest,xTest,xTest,xTest], y_test),#,
    ...
    score = combModel.evaluate([xTest,xTest,xTest,xTest],
        y=y_test)
...
def mergeModels(mod50p10, mod30p10,mod50p50, mod30p50):
    ...
    mod50pend10 = mod50p10.layers[-1].get_input_at(0)
    mod30pstart10 = mod30p10.layers[0].get_output_at(0)
    mod30pend10 = mod30p10.layers[-1].get_input_at(0)
    
    mod50pstart50 = mod50p50.layers[0].get_output_at(0)
    mod50pend50 = mod50p50.layers[-1].get_input_at(0)
    mod30pstart50 = mod30p50.layers[0].get_output_at(0)
    mod30pend50 = mod30p50.layers[-1].get_input_at(0)
    ...
    print("mod50pend shape is ", mod50pend1.shape)
    print("mod50pend shape is ", mod30pend1.shape)
    ...
    print("mod50pend shape is ", mod50pend5.shape)
    print("mod30pend shape is ", mod30pend5.shape)         
    concatC = Concatenate(name='outconCat',axis=1) ([mod50pend1,mod30pend1,mod50pend5,mod30pend5])
...
if __name__ == '__main__':
    ...
    combModel = mergeModels(mod50p1, mod30p1,mod50p5, mod30p5)
