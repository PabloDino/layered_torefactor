...
if __name__ == '__main__':
    ...
    print('denseIn3', denseIn3.shape)
    b3_flatten = Flatten()(denseIn3)
    print('b3_flatten', b3_flatten.shape)
    #print('pool_2a', pool_2a.shape)
  
    re_10a = Reshape(target_shape=(49, 252),input_shape=(7,7 ,252))(b3_flatten)
    ls5a= LSTM(latent_dim*latent_dim,return_sequences=True,unit_forget_bias=1.0,dropout=0.2)(re_10a)
    print('ls5 a shape is ', ls5a.shape) 
    
    #re5a = Reshape(target_shape=(latent_dim*latent_dim ,latent_dim*latent_dim ))(ls5a)
    act_4a =Activation('relu')(ls5a)  
    b3_drop = Dropout(rate=0.5)(act_4a)
