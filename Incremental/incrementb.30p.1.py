...
if __name__ == '__main__':
    ...
    nextLabels =  totalLabel -  origLabels  
    ...
    dense17=Dense(origLabels)(drop16)
    #re17a = Reshape(target_shape=(1,origLabels))(dense17)

    print('dense shape',dense17.shape)  
    lsEndBranch = Model(inputs=[lsinput], outputs=dense17)
    ############################################################
    ...
    drop16_1=Dropout(rate=0.5)(act15_1)
    dense17_1=Dense(nextLabels)(drop16_1)
    #re17a_1 = Reshape(target_shape=(1,nextLabels))(dense17_1)

    branch1 = Model(inputs=[lsinput], outputs=dense17_1)

    srclayer =-11
    for layer in lsEndBranch.layers:
        if srclayer>=-10: 
    ...
    for i in range(origlen):
      if (i<(origlen - 10)):
        ...
        print('removing ', modelbase.layers[-1].name)
    ...
    concatC = Concatenate(axis=1, name = 'outconcat')([dense17_1,dense17])#Expt 1
    ...
    #print('dense shape',dense17.shape)  
    out = Activation('softmax')(concatC)
