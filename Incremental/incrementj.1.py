...
checkpoint = keras.callbacks.ModelCheckpoint(filepath, monitor='val_loss', verbose=0, save_best_only=True, save_weights_only=False, mode='auto', period=1000)
...
def mergeModels(mod50p10, mod30p10,mod20p10,mod50p50, mod30p50, mod20p50, layernum1, layernum2):
    ...
    if (layernum1>20) and (layernum2>127):
     ...
     drop50p1= Dropout(0.2)(bn50p1)
     drop30p1= Dropout(0.2)(bn30p1)
     drop20p1= Dropout(0.2)(bn20p1)
     drop50p5= Dropout(0.2)(bn50p5)
     drop30p5= Dropout(0.2)(bn30p5)
     drop20p5= Dropout(0.2)(bn20p5)
...
if __name__ == '__main__':
 ...
 trimmed50p5out = mod50p5.layers[-3].get_output_at(0)
 trimmed30p5out = mod30p5.layers[-3].get_output_at(0)
 trimmed20p5out = mod20p5.layers[-3].get_output_at(0)
