...
def buildModel(dataset):
   ...
   # 27 x 58 x 48
    ...
    re13 = Reshape(target_shape=(72, 36))(flat12)
    ls14= LSTM(latent_dim,return_sequences=True,unit_forget_bias=1.0,dropout=0.2)(re13)
    print('ls14 shape is ', ls14.shape) 
    at15 = Attention(latent_dim)(ls14)
    print('at15 shape is ', at15.shape) 

    drop13 = Dropout(rate=0.5)(at15)
