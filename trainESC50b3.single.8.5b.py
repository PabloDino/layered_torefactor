...
print('creating net')    
densenet = DenseNet((128,128,1), nb_classes=25, depth=25)
...
filepath = "Dense25.omp.Aug-{epoch:02d}-{loss:.2f}.hdf5"
...
model.save('models/SingleModel.4.50p.dense25.aug300.drop0.2.h5')        
model_comp.save('models/SingleModel.4.comp.aug300.h5')
