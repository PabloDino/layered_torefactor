...
filepath = "coarse256att-model-{epoch:02d}-{loss:.2f}.hdf5"
...
vae.save_weights('att256_mlp_mnist_latent_dim_%s.h5' %latent_dim)
#vae.save('vae_coarse_model.h5')
encoder.save('encoder.att256.h5')
"""
...
def plot_label_clusters(vae, data, labels):
    ...
    plt.ylabel("z[1]")
    #plt.show()
    plt.savefig("clusters.att256.png")
