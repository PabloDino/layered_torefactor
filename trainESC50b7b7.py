...
if __name__ == '__main__':
    ...
    vaefine.built=True
    vaecoarse.built=True
    vaefine =tf.keras.models.load_model('denoiser_2.hdf5')#, custom_objects={'sampling': sampling}, compile =False)
    vaecoarse =tf.keras.models.load_model('denoiser_2.hdf5')#, custom_objects={'sampling': sampling}, compile =False)
